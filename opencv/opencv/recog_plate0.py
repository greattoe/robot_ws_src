import rclpy, cv2, random, os, sys
...
class ImageConvertor(Node):
    def __init__(self):
        ...
        self.create_subscription(CompressedImage, 
                ...
                self.get_compressed,
                10)
        self.cv_img = np.zeros([480,640]) # self.cv_img = cv2.imread("ref320.png")
    ...
    try:
        while rclpy.ok():
            ...
            if frame is None:
                ...
                print("before find_chars function")#-------------------------------------------------
                ...
                for i, matched_chars in enumerate(matched_result):
                    ...
                    img_rotated = cv2.warpAffine(img_thresh, M=rotation_matrix, dsize=(640, 480))
